...
func TestEncodeArraysMatchesCast(t *testing.T) {
	var s1, r1, r2 [32]byte
	s1[31] = 1
	r1[31] = 0xa
	r2[31] = 0xb
	w, _ := ParseAddress("0x000000000000000000000000000000000000000a")
	got := EncodeArrays("recordTrades(bytes32[],address[],int128[],uint64[],bytes32[])",
		[][32]byte{s1, s1}, [][32]byte{Word(w), Word(w)}, [][32]byte{Word(big.NewInt(5)), Word(big.NewInt(-1))},
		[][32]byte{Word(uint64(100)), Word(uint64(200))}, [][32]byte{r1, r2})
	want := mustHex(t, "0x"+castRecordTrades)
	if hex.EncodeToString(got) != hex.EncodeToString(want) {
		t.Fatalf("calldata\n got %x\nwant %x", got, want)
	}
}

const castRecordTrades = ""
